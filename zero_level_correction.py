...
print('-------------------------------')
zero_level = (image_mean+image_median)/2
print('')
print('Subtracting the Zero level value from pixel Brightness throught the image')
data -= zero_level
print('')
print('Writing zero level corrected image')
fits.writeto(fits_image.replace(".fits", "_Zero_lev_corr.fits"), data, hdr, overwrite=True)
print('---------------- ')
print('Output Image: '+fits_image.replace(".fits", "_Zero_lev_corr.fits"))
print('---------------- ')
